    ...
    return (
        <div className="min-h-screen bg-[#F0F2F5]">
            ...
            <div
                ...
                style={{
                    background: "linear-gradient(170deg, #060E1A 0%, #0A1A30 25%, #0D2244 50%, #091B35 75%, #060E1A 100%)"
                }}>
                {}
                <div
                ...
                <div className="absolute inset-0 pointer-events-none overflow-hidden">
                    ...
                    {}
                    <div
                        className="absolute h-[1px] w-full opacity-[0.08]"
                        style={{
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div className="hidden lg:flex items-center gap-4 text-white/60 text-sm">
                                ...
                                <a
                                    ...
                                    <HeadphoneIcon className="w-4 h-4" />在线客服
                                                    </a>
                            </div>
                            {user ? <Link
                                href="/profile"
                                className="flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/8 text-white text-sm hover:bg-white/15 transition-all border border-white/10">
                                <UserIcon className="w-4 h-4" />
                                <span className="hidden sm:inline">{user.username}</span>
                            </Link> : <div className="flex items-center gap-2">
                                <Link
                                    href="/login"
                                    className="px-5 py-1.5 rounded-full bg-gradient-to-r from-[#1890FF] to-[#00D4FF] text-white text-sm font-medium shadow-sm shadow-blue-400/30 hover:shadow-md transition-all">登录</Link>
                                <Link
                                    href="/register"
                                    className="px-4 py-1.5 rounded-full border border-white/20 text-white/80 text-sm hover:bg-white/8 transition-all">注册</Link>
                            </div>}
                        </div>
                    </div>
                    {}
                    <div className="pb-4 pt-2 md:pt-8 md:pb-10">
                        <div
                            ...
                            <div>
                                <h1
                                    className="text-2xl md:text-4xl lg:text-5xl font-bold text-white mb-2 tracking-wide"
                                    style={{
                                        textShadow: "0 0 40px rgba(0,212,255,0.15)"
                                    }}>激发兴趣，引领增长
                                                    </h1>
                                <p className="text-white/35 text-xs md:text-sm tracking-wider">抖音电商优惠券抢购平台
                                                    </p>
                            </div>
                            {}
                            {activeSession && <div
                                className="flex items-center gap-2.5 bg-white/5 backdrop-blur-md rounded-2xl px-5 py-3 border border-white/8"
                                style={{
                                ...
                                <div className="flex items-center gap-0.5">
                                    {getCountdown(activeSession)?.split(":").map((val, i) => <span key={i} className="flex items-center">
                                        <span
                                            className="bg-white/8 text-white text-sm md:text-base font-bold font-mono px-2 py-1 rounded-md tabular-nums min-w-[32px] text-center"
                                            style={{
                            ...
                            {!activeSession && nextSession && <div
                                className="flex items-center gap-2.5 bg-white/4 rounded-2xl px-5 py-3 border border-white/5">
                                <span className="text-amber-400 text-xs font-medium">{nextSession.name}即将开始</span>
                                <div className="flex items-center gap-0.5">
                                    {getCountdown(nextSession)?.split(":").map((val, i) => <span key={i} className="flex items-center">
                                        <span
                                            className="bg-white/6 text-white/60 text-sm md:text-base font-bold font-mono px-2 py-1 rounded-md tabular-nums min-w-[32px] text-center">{val}</span>
                ...
                {}
                <div
                    className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-8 md:pb-16 pt-4 md:pt-8">
                    <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-16">
                            ...
                            <h2
                                ...
                                style={{
                                    textShadow: "0 0 60px rgba(0,212,255,0.2)"
                                                ...
                                                <br />
                                <span
                                    className="bg-clip-text text-transparent bg-gradient-to-r from-[#00D4FF] to-[#7B61FF]">引领增长
                                                    </span>
                            </h2>
                            <p
                                className="text-white/40 text-sm md:text-base mb-8 max-w-md mx-auto lg:mx-0 leading-relaxed"
                                style={{
                                    fontStyle: "italic"
                                }}>抖音电商优惠券抢购平台，限时抢购，一站式优惠服务<br><br></p>
                            {}
                            <div className="grid grid-cols-2 gap-3 max-w-sm mx-auto lg:mx-0">
                                <a
                                    href="/login"
                                    className="group relative bg-gradient-to-r from-[#1890FF] to-[#00D4FF] text-white text-sm font-semibold py-3 px-5 rounded-xl text-center transition-all hover:shadow-lg hover:shadow-[#1890FF]/25 hover:scale-[1.03] active:scale-[0.97]"
                                    style={{
                                ...
                                <a
                                    href="/announcements"
                                    className="group relative bg-white/8 backdrop-blur-sm text-white text-sm font-semibold py-3 px-5 rounded-xl text-center border border-white/10 transition-all hover:bg-white/12 hover:scale-[1.03] active:scale-[0.97]">了解更多
                                                    </a>
                            </div>
                        </div>
                        {}
                        <div className="flex-1 relative w-full max-w-lg lg:max-w-xl">
                            ...
                            <div className="relative h-[320px] md:h-[400px]">
                                {}
                                <div
                                    className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-56 md:w-72 bg-white/10 backdrop-blur-xl rounded-2xl border border-white/15 p-4 shadow-2xl"
                                    style={{
                                    ...
                                    <div className="space-y-2">
                                        <div className="flex items-center gap-2 bg-white/8 rounded-lg p-2">
                                            <div
                                                className="w-10 h-10 rounded-lg bg-gradient-to-br from-[#1890FF] to-[#00D4FF] flex items-center justify-center">
                                        ...
                                        <div className="flex items-center gap-2 bg-white/8 rounded-lg p-2">
                                            <div
                                                className="w-10 h-10 rounded-lg bg-gradient-to-br from-[#7B61FF] to-[#FE2C55] flex items-center justify-center">
                                ...
                                {}
                                <div
                                    className="absolute top-2 right-0 md:right-4 bg-white/10 backdrop-blur-xl rounded-xl border border-white/12 p-3 shadow-xl"
                                    style={{
                                ...
                                {}
                                <div
                                    className="absolute bottom-8 left-0 md:left-2 bg-white/10 backdrop-blur-xl rounded-xl border border-white/12 p-3 shadow-xl"
                                    style={{
                                    ...
                                    <div className="flex items-center gap-2">
                                        <div
                                            className="w-8 h-8 rounded-lg bg-[#FE2C55]/20 flex items-center justify-center">
                                ...
                                {}
                                <div
                                    className="absolute top-6 left-2 md:left-6 bg-white/10 backdrop-blur-xl rounded-xl border border-white/12 p-3 shadow-xl"
                                    style={{
                                    ...
                                    <div className="flex items-center gap-2">
                                        <div
                                            className="w-8 h-8 rounded-full bg-gradient-to-br from-[#1890FF] to-[#7B61FF]" />
                                        <div>
                                ...
                                <div
                                    ...
                                    style={{
                                        background: "radial-gradient(circle, rgba(123,97,255,0.8), transparent)",
                                        filter: "blur(15px)",
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                {}
                {articles.length > 0 && <div className="mt-3">
                    <Link
                        href="/announcements"
                        className="block bg-white rounded-xl shadow-sm px-4 py-2.5 hover:shadow-md transition-shadow">
                        <div className="flex items-center gap-3">
                            ...
                            <div className="flex-1 overflow-hidden relative h-5">
                                <div
                                    ...
                                    style={{
                                        transform: `translateY(-${currentAnnounceIdx * 100}%)`
                                    }}>
                                    {articles.map(
                                        a => <div key={a.id} className="w-full flex-shrink-0 h-5 flex items-center">
                ...
                <div className="mt-3 flex gap-4 pb-24 md:pb-8">
                    ...
                    <div className="hidden lg:block w-[220px] flex-shrink-0 space-y-3">
                        ...
                        <div className="bg-white rounded-2xl shadow-sm p-4 space-y-2">
                            ...
                            <button
                                ...
                                className={`w-full flex items-center gap-2 px-3 py-2.5 rounded-xl text-sm font-medium transition-all ${!selectedCategory ? "bg-gradient-to-r from-[#1890FF] to-[#00D4FF] text-white shadow-sm shadow-blue-500/20" : "bg-gray-50 text-gray-600 hover:bg-gray-100"}`}>
                                <CouponIcon className="w-4 h-4" />全部券
                                              </button>
                            {categories.map(cat => {
                                ...
                                return (
                                    <button
                                        ...
                                        className={`w-full flex items-center gap-2 px-3 py-2.5 rounded-xl text-sm font-medium transition-all ${selectedCategory === cat.id ? "bg-gradient-to-r from-[#1890FF] to-[#00D4FF] text-white shadow-sm shadow-blue-500/20" : "bg-gray-50 text-gray-600 hover:bg-gray-100"}`}>
                        ...
                        <div className="bg-white rounded-2xl shadow-sm p-4 space-y-2">
                            ...
                            {sessions.map(session => {
                                ...
                                return (
                                    <div
                                        key={session.id}
                                        className={`px-3 py-2.5 rounded-xl text-sm ${status === "active" ? "bg-blue-50 border border-blue-100" : "bg-gray-50"}`}>
                                        <div className="flex items-center justify-between">
                                            <div className="flex items-center gap-2">
                                                ...
                                                <span
                                                    className={`font-medium ${status === "active" ? "text-[#1890FF]" : "text-gray-600"}`}>{session.name}</span>
                                            </div>
                                            <span className="text-gray-400 text-xs">{session.start_time}-{session.end_time}</span>
                                        </div>
                                        {countdown && status === "active" && <div className="mt-1.5 text-xs text-[#1890FF] font-mono tabular-nums">{countdown}后结束</div>}
                                        {status === "upcoming" && countdown && <div className="mt-1.5 text-xs text-amber-500 font-mono tabular-nums">{countdown}后开始</div>}
                                    </div>
                                );
                            })}
                        </div>
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        <div className="flex lg:hidden gap-2 mb-3 overflow-x-auto pb-1 scrollbar-hide">
                            <button
                                onClick={() => setSelectedCategory("")}
                                className={`flex-shrink-0 flex items-center gap-1 px-4 py-2 rounded-full text-xs font-medium transition-all mr-2 ${!selectedCategory ? "bg-gradient-to-r from-[#1890FF] to-[#00D4FF] text-white shadow-sm" : "bg-white text-gray-600 shadow-sm"}`}>
                                <CouponIcon className="w-3.5 h-3.5" />全部
                                              </button>
                            {categories.map(cat => {
                                const IconComponent = categoryIconMap[cat.name];
                                ...
                                return (
                                    <button
                                        key={cat.id}
                                        onClick={() => setSelectedCategory(selectedCategory === cat.id ? "" : cat.id)}
                                        className={`flex-shrink-0 flex items-center gap-1 px-4 py-2 rounded-full text-xs font-medium transition-all mr-2 ${selectedCategory === cat.id ? "bg-gradient-to-r from-[#1890FF] to-[#00D4FF] text-white shadow-sm" : "bg-white text-gray-600 shadow-sm"}`}>
                        ...
                        <div className="md:hidden mb-3">
                            {activeSession ? <div
                                className="flex items-center justify-between px-4 py-2.5 bg-gradient-to-r from-[#1890FF]/5 to-[#00D4FF]/5 rounded-xl border border-[#1890FF]/10">
                                <div className="flex items-center gap-2">
                                    <span className="flex h-2 w-2 relative">
                                        <span
                                            className="animate-ping absolute inline-flex h-full w-full rounded-full bg-green-400 opacity-75"></span>
                                ...
                                className="px-3 py-2 bg-amber-50 border border-amber-100 rounded-lg text-center">
                        ...
                        {}
                        {filteredCoupons.length === 0 ? <div className="text-center py-20 bg-white rounded-2xl shadow-sm">
                            ...
                            {filteredCoupons.map(coupon => <Link
                                key={coupon.id}
                                ...
                                <div
                                    ...
                                    <div
                                        className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/50 to-transparent pt-8 pb-1.5 px-2.5">
                                        <span className="text-white font-bold text-sm md:text-base">¥{coupon.price.toLocaleString()}</span>
                                    </div>
                                    {coupon.remaining_quantity === 0 && <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
                                        <span className="text-white font-bold text-sm bg-black/30 px-3 py-1 rounded-lg">已售罄</span>
                                    </div>}
                                </div>
                                <div className="p-2.5 md:p-3">
                                    <h3
                                        className="text-xs md:text-sm font-medium text-gray-800 line-clamp-2 mb-1.5 leading-tight">{coupon.name}</h3>
                                    <div className="flex items-center justify-between">
                                        <span className="text-[10px] text-[#FE2C55] font-medium">已抢999+</span>
                                    </div>
                                    {canGrab && coupon.remaining_quantity > 0 ? <div
                                        className="mt-2 w-full py-1.5 rounded-lg bg-gradient-to-r from-[#1890FF] to-[#00D4FF] text-white text-xs font-medium text-center group-hover:shadow-md group-hover:shadow-blue-400/20 transition-all">立即抢购
                                                                </div> : coupon.remaining_quantity > 0 ? <div
                                        className="mt-2 w-full py-1.5 rounded-lg bg-gray-100 text-gray-400 text-xs font-medium text-center">非活动时间
                                                                </div> : null}
                                </div>
                            </Link>)}
                        </div>}
